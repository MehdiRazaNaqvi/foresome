      ...
      <div className="foresome_screen2">
        ...
        <div className="signup_div" style={{ marginBottom: "5rem" }}>
          ...
          <span className="signup_right">
            <Input className='screen2_input' style={{ backgroundColor: "transparent", color: "white" }} placeholder='Your Email' />
            <Button color="light" style={{ color: "rgba(23, 107, 58, 1)" }}>Subscribe</Button>{' '}
          </span>
